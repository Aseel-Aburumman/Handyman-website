...
<head>
  ...
  <link href="{{ asset('admin/css/mainPortal.css') }}" rel="stylesheet">
...
<body>
    ...
    <section class="section error-404 min-vh-100 d-flex flex-column align-items-center justify-content-center">
        <img src="{{ asset('pic/logoHorizantal.png')}}" class="img-fluid py-5" alt="Page Not Found">
        ...
        <div style="background-color: #ffffff; padding: 30px; border-radius: 10px; box-shadow: 0 4px 8px rgba(0, 0, 0, 0.1);">
            ...
            <a class="btn" href="{{ route('admin.register') }}">Register</a>
        </div>
