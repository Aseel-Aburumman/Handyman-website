                            ...
                            <div class="tab-content pt-2">
                                <div class="tab-pane fade show active profile-overview" id="profile-overview">
                                    ...
                                    <div class="row mb-2">
                                        ...
                                        <div class="col-lg-8 col-md-8">{{ $deliveryInfo->building_no ?? 'Not provided' }}, {{ $deliveryInfo->location ?? 'Not provided' }}, {{ $deliveryInfo->city ?? 'Not provided' }}</div>
                                    </div>
                                    ...
                                    <div class="row mb-2">
                                        ...
                                        <div class="col-lg-8 col-md-8">{{ $store_owner->storeOwner->contact_number ?? 'Not provided' }}</div>
                                    </div>
                                    ...
                                    <div class="row mb-2">
                                        ...
                                        <div class="col-lg-8 col-md-8">{{ $store_owner->storeOwner->certificate_id ?? 'Not provided' }}</div>
                                    </div>

                                    <div class="row mb-2">
                                        <div class="col-lg-4 col-md-4 label">Description</div>
                                        <div class="col-lg-8 col-md-8">{{ $store->description ?? 'Not provided' }}</div>
                                    </div>
                                    ...
                                    <div class="row mt-4">
                                        <div class="col-lg-12 text-center">
                                            ...
                                            <a href="{{ route('admin.dashboard', ['id' => $store_owner->id]) }}" class="btn btn-primary btn-lg">
