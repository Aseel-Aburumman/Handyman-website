        ...
        <div class="row">
                        ...
                        <div class="col-md-8">
                            <div class="card chat-card shadow-sm">
                                ...
                                <div class="card-footer chat-footer">
                                    <form action="{{ route('chat.sendadmin2') }}" method="POST">
                                        @csrf
                                ...
                                <div class="card-body chat-history-body">
                                    @if ($chatPartners->isNotEmpty())
                                        @foreach ($chatPartners as $partner)
                                            <a href="{{ route('chatadmin2', ['receiverId' => $partner->id]) }}"
            ...
            <script>
                ...
                function fetchMessages() {
                    ...
                    $.ajax({
                        url: `{{ route('chat.fetchadmin2', ['receiverId' => ':receiverId']) }}`.replace(':receiverId',
