        ...
        <div class="row">
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <form class="row g-3" method="POST" action="{{ route('admin.update_store_owner', $store_owner->id) }}" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')

                        <div class="col-md-12">
                            <label for="inputName" class="form-label">Your Name</label>
                            <input type="text" name="name" class="form-control" id="inputName" value="{{ old('name', $store_owner->name) }}">
                        </div>
                        <div class="col-md-6">
                            <label for="inputEmail" class="form-label">Email</label>
                            <input type="email" name="email" class="form-control" id="inputEmail" value="{{ old('email', $store_owner->email) }}">
                        </div>
                        <div class="col-md-6">
                        ...
                        <div class="col-md-12">
                            ...
                            @if($store_owner->image)
                                <img src="{{ url('/user_images/' . $store_owner->image) }}" alt="Profile Image" class="img-thumbnail mt-2" width="150">
                            @endif
                        </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" name="store_name" class="form-control" id="store_name" value="{{ old('store_name', $storeOwnerDetails->store_name ?? '') }}">
                        </div>
                        <div class="col-md-6">
                            <label for="contact_number" class="form-label">Contact Number</label>
                            <input type="text" name="contact_number" class="form-control" id="contact_number" value="{{ old('contact_number', $storeOwnerDetails->contact_number ?? '') }}">
                        </div>
                        <div class="col-md-6">
                            <label for="address" class="form-label">Store Address</label>
                            <input type="text" name="address" class="form-control" id="address" value="{{ old('address', $storeOwnerDetails->address ?? '') }}">
                        </div>
                        <div class="col-md-6">
                            <label for="certificate_id" class="form-label">Certificate Id</label>
                            <input type="text" name="certificate_id" class="form-control" id="certificate_id" value="{{ old('certificate_id', $storeOwnerDetails->certificate_id ?? '') }}">
                        </div>
                        <div class="col-md-6">
                            <label for="store_location" class="form-label">Store Location</label>
                            <input type="text" name="store_location" class="form-control" id="store_location" value="{{ old('store_location', $storeDetails->location ?? '') }}">
                        </div>
                        <div class="col-md-6">
                            <label for="description" class="form-label">Store Description</label>
                            <input type="text" name="description" class="form-control" id="description" value="{{ old('description', $storeDetails->description ?? '') }}">
                        </div>
                        <div class="col-md-6">
                            <label for="status_id" class="form-label">Store Status</label>
                            <input type="text" name="status_id" class="form-control" id="status_id" value="{{ old('status_id', $storeDetails->status_id ?? '') }}">
                        </div>
                        <div class="col-md-6">
                            <label for="rating" class="form-label">Store Rating</label>
                            <input type="text" name="rating" class="form-control" id="rating" value="{{ old('rating', $storeDetails->rating ?? '') }}">
                        </div>
