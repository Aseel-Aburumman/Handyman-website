                ...
                <div class="card-body">
                    ...
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>{{ $store->name }}</td>
                                <td>{{ $store->storeOwner->user->name }}</td> <!-- Access the owner's user name -->
                                <td>{{ $store->products_count }}</td>
                                <td>{{ $store->status->name }}</td>
                                <td>
                                    <a href="{{ route('store_control_center.view_store', ['id' => $store->id]) }}" class="btn btn-info btn-sm">View</a>
                                    <a href="{{ route('store_control_center.edit_store', $store->id) }}" class="btn btn-warning btn-sm">Edit</a>
                                    <a href="{{ route('store_control_center.delete_store', $store->id) }}" class="btn btn-danger btn-sm">Delete</a>
                                </td>
                            </tr>
                            @endforeach
                        </tbody>
