                ...
                <div class="card-body">
                    ...
                    <div class="d-flex align-items-center">
                        ...
                        <div class="ps-3">
                            ...
                            <span class="text-muted small pt-2 ps-1">Revenue: ${{ number_format($monthlyRevenue, 2) }}</span>
                        </div>
                    </div>
                </div>
              </div>
                ...
                <div class="card-body">
                    ...
                    <div class="d-flex align-items-center">
                        ...
                        <div class="ps-3">
                            ...
                            <span class="text-muted small pt-2 ps-1">Revenue: ${{ number_format($weeklyRevenue, 2) }}</span>
                        </div>
                    </div>
                </div>
              </div>
