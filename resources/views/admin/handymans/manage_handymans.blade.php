                        ...
                        <tbody>
                            @foreach($users as $user)
                                <tr>
                                    ...
                                    <td class="actions">
                                        <a href="{{ route('admin.view_handyman', ['id' => $user->id]) }}" class="fa-solid fa-eye"></a>
                                        <a href="{{ route('admin.edit_handyman', ['id' => $user->id]) }}" class="fa-solid fa-pencil"></a>
                                        <form action="{{ route('admin.delete_handyman', ['id' => $user->id]) }}" method="POST" style="display:inline;" onsubmit="return confirm('Are you sure you want to delete this customer?');">
                                            @csrf
                                            @method('DELETE')
