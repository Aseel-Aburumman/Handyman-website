        ...
        <div class="tab-content pt-2">
            <div class="tab-pane fade show active profile-overview" id="profile-overview">
                ...
                <div class="row mb-2">
                    ...
                    <div class="col-lg-8 col-md-8">{{ $deliveryInfo->phone ?? 'Not provided' }}</div>
                </div>

                <!-- Handyman Details -->
                <div class="row mb-2">
                    <div class="col-lg-4 col-md-4 label">Experience</div>
                    <div class="col-lg-8 col-md-8">{{ $handyman->handyman->experience ?? 'Not provided' }} years</div>
                </div>

                <div class="row mb-2">
                    <div class="col-lg-4 col-md-4 label">Bio</div>
                    <div class="col-lg-8 col-md-8">{{ $handyman->handyman->bio ?? 'Not provided' }}</div>
                </div>

                <div class="row mb-2">
                    <div class="col-lg-4 col-md-4 label">Store Location</div>
                    <div class="col-lg-8 col-md-8">{{ $handyman->handyman->store_location ?? 'Not provided' }}</div>
                </div>

                <!-- Delivery Info Details -->
                <div class="row mb-2">
                    <div class="col-lg-4 col-md-4 label">Address</div>
                    <div class="col-lg-8 col-md-8">{{ $deliveryInfo->location ?? 'Not provided' }}, {{ $deliveryInfo->building_no ?? '' }}</div>
                </div>

                <div class="row mb-2">
                    <div class="col-lg-4 col-md-4 label">City</div>
                    <div class="col-lg-8 col-md-8">{{ $deliveryInfo->city ?? 'Not provided' }}</div>
                </div>
                ...
                <div class="row mt-4">
                    <div class="col-lg-12 text-center">
                        ...
                        <!-- Delete Button -->
                        <form action="{{ route('admin.delete_handyman', ['id' => $handyman->id]) }}" method="POST" style="display:inline;" onsubmit="return confirm('Are you sure you want to delete this handyman?');">
                            @csrf
                            @method('DELETE')
