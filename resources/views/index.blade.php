                    ...
                    <div class="hero-inner">
                        <div class="container">
                            <div class="hero-style1">
                                ...
                                <h1 class="hero-title">
                                    <span class="title1" data-ani="slideinup" data-ani-delay="0.2s">{{ __('messages.bannerTitleA1') }}</span>
                                    <span class="title2" data-ani="slideinup" data-ani-delay="0.4s">{{ __('messages.bannerTitleA2') }}</span>
                                    <span class="title3" data-ani="slideinup" data-ani-delay="0.6s">{{ __('messages.bannerTitleA3') }}
                                    {{--  <span class="text-theme">2003</span>  --}}
                                    </span>
                                </h1>
                                <p class="hero-text" data-ani="slideinup" data-ani-delay="0.8s">{{ __('messages.bannerSubTitleA1') }}</p>
                                <a href="{{ route('service') }}" class="th-btn style3" data-ani="slideinup" data-ani-delay="1s">{{ __('messages.bannerBtn') }}<i class="fas fa-arrow-right ms-2"></i></a>
                            </div>
                        </div>
                    ...
                    <div class="hero-inner">
                        <div class="container">
                            <div class="hero-style1">
                                ...
                                <h1 class="hero-title">
                                    <span class="title1" data-ani="slideinup" data-ani-delay="0.2s">{{ __('messages.bannerTitleB1') }}</span>
                                    <span class="title2" data-ani="slideinup" data-ani-delay="0.4s">{{ __('messages.bannerTitleB2') }}</span>
                                    <span class="title3" data-ani="slideinup" data-ani-delay="0.6s">{{ __('messages.bannerTitleB3') }}
                                    {{--  <span class="text-theme">2003</span>  --}}
                                    </span>
                                </h1>
                                <p class="hero-text" data-ani="slideinup" data-ani-delay="0.8s">{{ __('messages.bannerSubTitleB1') }}</p>
                                <a href="service.html" class="th-btn style3" data-ani="slideinup" data-ani-delay="1s">{{ __('messages.bannerBtn') }}<i class="fas fa-arrow-right ms-2"></i></a>
                            </div>
                        </div>
                        <div class="hero-img" data-ani="slideinright" data-ani-delay="0.2s">
                            <div class="shape1">
                    ...
                    <div class="hero-inner">
                        <div class="container">
                            <div class="hero-style1">
                                ...
                                <h1 class="hero-title">
                                    <span class="title1" data-ani="slideinup" data-ani-delay="0.2s">{{ __('messages.bannerTitleC1') }}</span>
                                    <span class="title2" data-ani="slideinup" data-ani-delay="0.4s">{{ __('messages.bannerTitleC2') }}</span>
                                    <span class="title3" data-ani="slideinup" data-ani-delay="0.6s">{{ __('messages.bannerTitleC3') }}
                                     {{--  <span class="text-theme">2003</span>  --}}
                                     </span>
                                </h1>
                                <p class="hero-text" data-ani="slideinup" data-ani-delay="0.8s">{{ __('messages.bannerSubTitleC1') }}</p>
                                <a href="service.html" class="th-btn style3" data-ani="slideinup" data-ani-delay="1s">{{ __('messages.bannerBtn') }}<i class="fas fa-arrow-right ms-2"></i></a>
                            </div>
                        </div>
                        <div class="hero-img" data-ani="slideinright" data-ani-delay="0.2s">
            ...
            <div class="row justify-content-center">
                <div class="col-xl-8 col-md-10">
                    <div class="title-area text-center">
                        ...
                        <h2 class="sec-title">{{ __('messages.serviveTitle') }}
</h2>
                        <p class="sec-text">Welcome to Rakar renovation, we provide a robust synopsis for high level overviews. Organically grow the holistic world view of disruptive innovation via workplace diversity and empowerment.</p>
                    <div class="filter-menu style2 mt-0 indicator-active filter-menu-active">
                <button data-filter="*" class="tab-btn active" type="button">Assembly</button>
                <button data-filter=".cat1" class="tab-btn" type="button">Mounting</button>
                <button data-filter=".cat2" class="tab-btn" type="button">Moving</button>
                <button data-filter=".cat3" class="tab-btn" type="button">Cleaning</button>
                <button data-filter=".cat4" class="tab-btn" type="button">Outdoor Help</button>
                <button data-filter=".cat5" class="tab-btn" type="button">Home Repairs</button>
            </div>
                    ...
                    <div class="swiper-wrapper">
                        <div class="swiper-slide">
                            <div class="service-card">
                                ...
                                <p class="box-text">Our Repair all Services best offers quality help programs for corporate zone studying.</p>
                                <a href="service-details.html" class="th-btn btn-sm">Read More<i class="far fa-arrow-right ms-2"></i></a>
                            </div>
                        </div>
                        <div class="swiper-slide">
                            <div class="service-card">
            ...
            <div class="row flex-row-reverse">
                            ...
                            <div class="spin-text">
                                <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="300px" height="300px" viewBox="0 0 300 300" enable-background="new 0 0 300 300" xml:space="preserve">
                                    ...
                                    <g>
                                        ...
                                        <text fill="#fff">
                                            <textPath xlink:href="#circlePath">Rakar The Best Service Provider</textPath>
                                        </text>
                                    </g>
                                </svg>
                            </div>
                ...
                <div class="col-xl-6 text-center text-xl-start">
                    <div class="title-area mb-30 pe-xxl-5">
                        <span class="sub-title shape-white"><img src="assets/img/theme-img/title_icon_white.svg" alt="shape">About Us</span>
                    ...
                    <p class="mb-42 text-light">Welcome to Rakar renovation, we provide a robust synopsis for high level overviews. Iterative approaches to corporate strategy foster collaborative thinking to further the overall value proposition. Organically grow the holistic world view of disruptive innovation via workplace diversity and empowerment.</p>
                    ...
                    <div class="btn-group justify-content-center">
                        <a href="about.html" class="th-btn style3">Discover More<i class="far fa-arrow-right ms-2"></i></a>
                        <div class="call-btn">
                            <div class="play-btn">
            ...
            <div class="row justify-content-between align-items-center">
                <div class="col-md">
                    <div class="title-area text-center text-md-start">
                        <span class="sub-title"><img src="assets/img/theme-img/title_icon.svg" alt="shape">Our Projects</span>
                        <h2 class="sec-title">Our Recent Projects</h2>
                    </div>
                </div>
                <div class="col-md-auto">
                    <div class="sec-btn mt-n3 mt-md-0">
                        <a href="project.html" class="th-btn style4">View All Projects<i class="far fa-arrow-right ms-2"></i></a>
                    </div>
                </div>
            </div>
            <div class="row gy-4">
...
==============================-->
    <div class="overflow-hidden bg-white">
        <div class="shape-mockup spin" data-top="5%" data-right="0%"><img src="assets/img/shape/lines_1.png" alt="shape"></div>
        <div class="container">
            <div class="row">
                <div class="col-xl-5">
                    <div class="img-box2">
                ...
                <div class="col-xl-7 text-center text-xl-start align-self-center space-extra">
                    <div class="ps-xl-5 pb-30 pb-lg-0">
                        <div class="title-area">
                            ...
                            <p class="sec-text pe-xl-5 me-xxl-5">It has survived not only five centuries, but also the leap into typesetting, remaining essentially unchanged. It was popularised.</p>
                        </div>
                        ...
                        <a href="contact.html" class="th-btn style4">Appointment Now<i class="far fa-arrow-right ms-2"></i></a>
                    </div>
                </div>
            </div>
        </div>
...
==============================-->
<section class="overflow-hidden space">
    <div class="shape-mockup" data-top="0%" data-left="0%"><img src="assets/img/bg/why_bg_2.png" alt="shape"></div>
    <div class="container">
        <div class="title-area text-center">
            <span class="sub-title2"><img src="assets/img/theme-img/title_icon5.svg" alt="Icon">Why Choose Us</span>
            ...
            <div class="col-xl-4 col-md-6">
                <div class="why-feature-left">
                    <div class="why-feature">
                        ...
                        <h3 class="box-title">Professional Technician</h3>
                        <p class="box-text">Our master electrician has been working in the electrical field for over two decades.</p>
                    </div>
                    <div class="why-feature">
                        <div class="box-number">02</div>
                        <div class="box-icon">
            ...
            <div class="col-xl-4 col-md-6">
                <div class="why-feature-right">
                    <div class="why-feature">
                        ...
                        <h3 class="box-title">Trustworthy</h3>
                        <p class="box-text">Our master electrician has been working in the electrical field for over two decades.</p>
                    </div>
                    <div class="why-feature">
                        <div class="box-number">05</div>
                        ...
                        <h3 class="box-title">30 Days Warrantly</h3>
                        <p class="box-text">Our master electrician has been working in the electrical field for over two decades.</p>
                    </div>
                    <div class="why-feature">
                        <div class="box-number">06</div>
    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-xl-6 col-md-8">
                <div class="title-area text-center">
                    <span class="sub-title2"><img src="assets/img/theme-img/title_icon5_white.svg" alt="Icon">Working Process</span>
                    <h2 class="sec-title text-white">Follow Great Process</h2>
                    <p class="sec-text text-white">Our team of experts is equipped to assist you with a variety of pipe repair needs. Please share your email address to connect with us.</p>
                </div>
            </div>
        </div>
        ...
        <div class="process-box-wrap">
            <div class="process-box">
                ...
                <div class="box-content">
                    ...
                    <p class="box-text">Proactively envisioned multimedia based expertisee cross-media growth</p>
                </div>
            </div>
            <div class="process-box">
                <div class="box-number">02</div>
                <div class="box-content">
                    <h3 class="box-title">Get Estimation</h3>
                    <p class="box-text">Proactively envisioned multimedia based expertisee cross-media growth</p>
                </div>
            </div>
            <div class="process-box">
            ...
            <div class="process-box">
                <div class="box-number">04</div>
                <div class="box-content">
                    <h3 class="box-title">Deliver Project</h3>
                    <p class="box-text">Proactively envisioned multimedia based expertisee cross-media growth</p>
                </div>
            </div>
        </div>
    ...
    <section class="space">
        <div class="container z-index-common">
            <div class="row justify-content-between align-items-center">
                <div class="col-md">
                    <div class="title-area text-center text-md-start">
                        <span class="sub-title"><img src="assets/img/theme-img/title_icon.svg" alt="shape">Team Members</span>
            ...
            <div class="slider-area">
                <div class="swiper th-slider has-shadow" id="teamSlider1" data-slider-options='{"paginationType":"progressbar","breakpoints":{"0":{"slidesPerView":1},"576":{"slidesPerView":"1"},"768":{"slidesPerView":"2"},"992":{"slidesPerView":"3"},"1200":{"slidesPerView":"3"}}}'>
                    <div class="swiper-wrapper">
                        <!-- Single Item -->
                        <div class="swiper-slide">
...
==============================-->
    <div class="overflow-hidden bg-white">
        <div class="shape-mockup moving d-none d-xxl-block" data-bottom="0%" data-right="0%"><img src="assets/img/shape/man_shape_1.png" alt="shape"></div>
        <div class="container">
            <div class="row">
                <div class="col-xl-6">
                    <div class="img-box3">
                        ...
                        <div class="contact-process-wrap">
                            <div class="contact-process">
                                ...
                                <div class="media-body">
                                    ...
                                    <p class="box-text">Willing to go the extra mile to provide a quality job & service. Although we are based in the Manchester area.</p>
                                </div>
                            </div>
                            <div class="contact-process">
                                <div class="box-number">02</div>
                                <div class="media-body">
                                    ...
                                    <p class="box-text">Although we are based in the Manchester area, we work with fit out companies and contractors across the country.</p>
                                </div>
                            </div>
                            <div class="contact-process">
                                <div class="box-number">03</div>
                                <div class="media-body">
                                    ...
                                    <p class="box-text">We work with fit out companies and other contractors across the country.Although we are based in the Manchester area.</p>
                                </div>
                            </div>
                            <div class="contact-process">
                                <div class="box-number">04</div>
                                <div class="media-body">
                                    ...
                                    <p class="box-text">Delivery with fit out companies and other contractors across the country.Although we are based in the Manchester area.</p>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-xl-6 text-center text-xl-start align-self-center space-extra">
                    <div class="title-area">
                        <span class="sub-title"><img src="assets/img/theme-img/title_icon.svg" alt="shape">Book an appointment</span>
...
==============================-->
    <section class="space" data-bg-src="assets/img/bg/pattern_bg_2.jpg">
        <div class="shape-mockup spin" data-top="15%" data-right="6%"><img src="assets/img/shape/dots_1.svg" alt="shape"></div>
        <div class="shape-mockup spin" data-bottom="6%" data-left="4%"><img src="assets/img/shape/dots_1.svg" alt="shape"></div>
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-xl-8">
                    <div class="title-area text-center">
                        <span class="sub-title shape-white"><img src="assets/img/theme-img/title_icon_white.svg" alt="Icon">Pricing Plan</span>
                        <h2 class="sec-title text-white">Our Best Pricing Plan</h2>
                        <p class="sec-text text-light">The popular belief, Lorem Ipsum is not simply random text. It has roots in a piece of classical Latin literature from 45 BC, making it over 2000 years old. Richard McClintock.</p>
                    </div>
                </div>
            </div>
