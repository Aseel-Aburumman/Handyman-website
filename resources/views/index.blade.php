            ...
            <div class="row justify-content-center">
                <div class="col-xl-8 col-md-10">
                    <div class="title-area text-center">
                        <span class="sub-title"><img src="assets/img/theme-img/title_icon.svg" alt="Icon">{{ __('messages.serviceSmallTitle') }}</span>
...
<div class="filter-menu style2 mt-0 indicator-active filter-menu-active">
    @foreach ($categories as $index => $category)
        <button data-filter=".cat{{ $index }}" class="tab-btn" type="button">{{ $category->name }}</button>
    @endforeach
</div>
                    </div>
                </div>
...
@foreach ($categories as $index => $category)
    <div class="swiper th-slider has-shadow category-services cat{{ $index }}" style="display:none" data-slider-options='{"loop":false,"slidesPerGroup":"2","breakpoints":{"0":{"slidesPerView":1},"576":{"slidesPerView":"1"},"768":{"slidesPerView":"2"},"992":{"slidesPerView":"2"},"1200":{"slidesPerView":"3"},"1300":{"slidesPerView":"4"}}}'>
        <div class="swiper-wrapper">
                    ...
                    <div class="service-card">
                        ...
                        <div class="box-icon">
                            ...
                            {{--  @if (isset($serviceImages[$service->name]))  --}}
                                ...
                                <img src="{{ asset('assets/img/icon/' .$serviceImages[$service->name]) }}" alt="Icon">
                        ...
                        <h3 class="box-title"><a href="service-details.html">{{ $service->name }}</a></h3>
