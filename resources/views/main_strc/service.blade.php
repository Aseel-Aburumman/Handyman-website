    ...
    <div class="breadcumb-wrapper " data-bg-src="assets/img/bg/breadcumb-bg.jpg">
        <div class="container">
            <div class="breadcumb-content">
                <h1 class="breadcumb-title">{{ __('messages.serviceSmallTitle') }}
                </h1>
                <ul class="breadcumb-menu">
                    <li><a href="{{ route('home') }}">{{ __('messages.Home') }}
                        </a></li>
                    <li>{{ __('messages.serviceSmallTitle') }}
                    </li>
                </ul>
            </div>
        </div>
...
==============================-->  --}}
    <section class="overflow-hidden space" id="service-sec" data-bg-src="assets/img/bg/pattern_bg_1.png">
        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-xl-8 col-md-10">
                    <div class="title-area text-center">
                        ...
                        <p class="sec-text">{{ __('messages.serviveDescription') }}
                        </p>
                    </div>
                </div>
            ...
            @foreach ($categories as $index => $category)
                <div class="row gy-3 category-services cat{{ $index }}" style="display:none">
                    @foreach ($category->services as $service)
                        <div class="col-xxl-4 col-lg-4 col-md-6">
                            <div class="service-card">
                                ...
                                @if (app()->getLocale() == 'en')
                                    <a href="javascript:void(0);" class="th-btn btn-sm">{{ __('messages.BookNow') }}&nbsp
