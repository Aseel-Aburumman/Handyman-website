    ...
    <div class="breadcumb-wrapper " data-bg-src="{{ asset('assets/img/bg/breadcumb-bg.jpg') }}">
        <div class="container">
            <div class="breadcumb-content">
                <h1 class="breadcumb-title">{{ __('messages.aboutSmallTitle') }}</h1>
                <ul class="breadcumb-menu">
                    <li><a href="{{ route('home') }}">{{ __('messages.Home') }}</a></li>
                    <li>{{ __('messages.aboutSmallTitle') }}</li>
                </ul>
            </div>
        </div>
    </div>
            ...
            <div class="row align-items-center">
                <div class="col-xl-4 text-center text-xl-start">
                    <div class="title-area mb-37">
                        ...
                        <h2 class="sec-title">{{ __('messages.aboutBigTitle') }}</h2>
                        <p class="sec-text">{{ __('messages.aboutDescriptiopA') }} </p>
                    </div>
                    <div class="checklist mb-45">
                        <ul>
                            <li>{{ __('messages.whyTitle4') }}</li>
                            <li>{{ __('messages.whyTitle1') }}</li>
                            <li>{{ __('messages.whyTitle6') }}</li>
                        </ul>
                    </div>
                    <div class="btn-group justify-content-center btn-mr">
                        {{--  <a href="about.html" class="th-btn style4">Discover More<i class="fa fa-arrow-right ms-2"></i></a>  --}}
                        <div class="call-btn">
                            <div class="play-btn">
                ...
                <div class="col-xl-4">
                    <div class="contact-process-wrap no-bg">
                        <div class="contact-process">
                            ...
                            <div class="media-body">
                                <h3 class="box-title text-title">{{ __('messages.processTitle1') }}</h3>
                                <p class="box-text text-body">{{ __('messages.process2b') }}</p>
                            </div>
                        </div>
                        <div class="contact-process">
                            ...
                            <div class="media-body">
                                ...
                                <p class="box-text text-body">{{ __('messages.process1b') }}</p>
                            </div>
                        </div>
                        <div class="contact-process">
                            ...
                            <div class="media-body">
                                ...
                                <p class="box-text text-body">{{ __('messages.process3b') }}</p>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="title-area text-center">
                        ...
                        <div class="serviceAboutUs filter-menu style2 mt-0 indicator-active filter-menu-active">
                            @foreach ($categories as $index => $category)
                                <button data-filter=".cat{{ $index }}" class="serviceAboutUsSmall tab-btn"
                ...
                <div class="col-xl-7 text-center text-xl-start align-self-center space-extra">
                    <div class="ps-xl-5 pb-30 pb-lg-0">
                        <div class="title-area">
                            <span class="sub-title"><img src="assets/img/theme-img/title_icon.svg"
                                    alt="shape">{{ __('messages.whySmallTitle') }}</span>
                            <h2 class="sec-title">{{ __('messages.whyBigTitle') }}</h2>
                            <p class="sec-text pe-xl-5 me-xxl-5">{{ __('messages.aboutDescriptiopB') }}</p>
                        </div>
                        ...
                        <a href="{{ route('contact') }}" class="th-btn style4">{{ __('messages.ContactUs') }}<i
            ...
            <div class="swiper-wrapper">
                <div class="swiper-slide">
                    <div class="gallery-insta">
                        <a target="_blank" href="https://www.instagram.com/p/C6yIzzALxZe/" class="box-btn"><i
