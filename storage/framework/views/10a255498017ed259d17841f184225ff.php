                        ...
                        <table class="table table-bordered">
                            <thead>
                                <tr>
                                    ...
                                    <th class="tableHide">Average Rating</th>
                                    <th>Actions</th>
                                </tr>
                            </thead>
                            <tbody>
                                <?php $__empty_1 = true; $__currentLoopData = $Rhandymen; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $handyman): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <tr>
                                        ...
                                        <td><?php echo e($handyman->gigs->where('status_id', 9)->count()); ?></td>
                                        <!-- Assuming '9' is the 'Completed' status -->
                                        <td class="tableHide"><?php echo e(number_format($handyman->reviews->avg('rating'), 2)); ?></td>
                                        <td>
                                            <a href="<?php echo e(route('admin.view_handyman', $handyman->id)); ?>"
                                                class="btn btn-info btn-sm">View</a>
                                            <?php if($handyman->suspended): ?>
                                                <form action="<?php echo e(route('admin.unsuspend_handyman', $handyman->id)); ?>"
                                                    method="POST" style="display:inline;">
                                                    <?php echo csrf_field(); ?>
                                                    <button type="submit" class="btn btn-success btn-sm">Unsuspend</button>
                                                </form>
                                            <?php else: ?>
                                                <form action="<?php echo e(route('admin.suspend_handyman', $handyman->id)); ?>"
                                                    method="POST" style="display:inline;">
                                                    <?php echo csrf_field(); ?>
                            ...
                            <tbody>
                                <?php $__currentLoopData = $handymen; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $handyman): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        ...
                                        <td class="tableHide"><?php echo e(number_format($handyman->reviews->avg('rating'), 2)); ?></td>
                                        <td>
                                            <a href="<?php echo e(route('admin.view_handyman', $handyman->user->id)); ?>"
                                                class="btn btn-info btn-sm">View</a>
