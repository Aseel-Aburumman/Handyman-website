                    ...
                    <div class="card-body profile-card pt-4">
                        ...
                        <div class="row w-100">
                            ...
                            <div class="col-lg-4 d-flex justify-content-center align-items-center">
                                <img src="<?php echo e($handyman->image ? url('/user_images/' . $handyman->image) : url('assets/img/profile-img.jpg')); ?>"
                                    ...
                                    <div class="tab-pane fade show active profile-overview" id="profile-overview">
                                        ...
                                        <div class="row mb-2">
                                            ...
                                            <div class="col-lg-8 col-md-8">
                                                <?php echo e($handyman->handyman->experience ?? 'Not provided'); ?> years</div>
                                        </div>

                                        <div class="row mb-2">
                                            <div class="col-lg-4 col-md-4 label">Bio</div>
                                            <div class="col-lg-8 col-md-8"><?php echo e($handyman->handyman->bio ?? 'Not provided'); ?>
                                        ...
                                        <div class="row mb-2">
                                            ...
                                            <div class="col-lg-8 col-md-8">
                                                <?php echo e($handyman->handyman->store_location ?? 'Not provided'); ?></div>
                                        </div>

                                        <!-- Delivery Info Details -->
                                        <div class="row mb-2">
                                            <div class="col-lg-4 col-md-4 label">Address</div>
                                            <div class="col-lg-8 col-md-8"><?php echo e($deliveryInfo->location ?? 'Not provided'); ?>,
                                                <?php echo e($deliveryInfo->building_no ?? ''); ?></div>
                                        </div>

                                        <div class="row mb-2">
                                            <div class="col-lg-4 col-md-4 label">City</div>
                                            <div class="col-lg-8 col-md-8"><?php echo e($deliveryInfo->city ?? 'Not provided'); ?>
                                        ...
                                        <div class="row mt-4">
                                            <div class="col-lg-12 text-center">
                                                ...
                                                <a href="<?php echo e(route('chatadmin2', ['receiverId' => $handyman->id])); ?>"
                                                    class="btn btn-primary btn-lg">
                                                    <i class="bi bi-chat-dots"></i> Go to Chat Center
                                                </a>

                                                <!-- Edit Button -->
                                                <a href="<?php echo e(route('admin.edit_handyman', ['id' => $handyman->id])); ?>"
                                                    class="btn btn-primary btn-lg">
                                                ...
                                                <!-- Delete Button -->
                                                <form
                                                    action="<?php echo e(route('admin.delete_handyman', ['id' => $handyman->id])); ?>"
