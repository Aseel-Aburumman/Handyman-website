                    ...
                    <div class="card-body profile-card pt-4">
                        ...
                        <div class="row w-100">
                            ...
                            <div class="col-lg-4 d-flex justify-content-center align-items-center">
                                <img src="<?php echo e($store_owner->image ? url('/user_images/' . $store_owner->image) : url('assets/img/profile-img.jpg')); ?>"
                                    ...
                                    <div class="tab-pane fade show active profile-overview" id="profile-overview">
                                        ...
                                        <div class="row mb-2">
                                            ...
                                            <div class="col-lg-8 col-md-8">
                                                <?php echo e($deliveryInfo->building_no ?? 'Not provided'); ?>,
                                                <?php echo e($deliveryInfo->location ?? 'Not provided'); ?>,
                                                <?php echo e($deliveryInfo->city ?? 'Not provided'); ?></div>
                                        </div>

                                        <div class="row mb-2">
                                            <div class="col-lg-4 col-md-4 label">Phone</div>
                                            <div class="col-lg-8 col-md-8"><?php echo e($deliveryInfo->phone ?? 'Not provided'); ?>
                                        ...
                                        <div class="row mb-2">
                                            ...
                                            <div class="col-lg-8 col-md-8">
                                                <?php echo e($store_owner->storeOwner->rating ?? 'Not provided'); ?></div>
                                        </div>
                                        ...
                                        <div class="row mb-2">
                                            ...
                                            <div class="col-lg-8 col-md-8">
                                                <?php echo e($store_owner->storeOwner->contact_number ?? 'Not provided'); ?></div>
                                        </div>
                                        ...
                                        <div class="row mb-2">
                                            ...
                                            <div class="col-lg-8 col-md-8">
                                                <?php echo e($store_owner->storeOwner->certificate_id ?? 'Not provided'); ?></div>
                                        </div>

                                        <div class="row mb-2">
                                            <div class="col-lg-4 col-md-4 label">Description</div>
                                            <div class="col-lg-8 col-md-8"><?php echo e($store->description ?? 'Not provided'); ?>
                                        ...
                                        <div class="row mt-4">
                                            <div class="col-lg-12 text-center">
                                                ...
                                                <a href="<?php echo e(route('chatadmin2', ['receiverId' => $store_owner->id])); ?>"
                                                    class="btn btn-primary btn-lg">
                                                    <i class="bi bi-chat-dots"></i> Go to Chat Center
                                                </a>

                                                <!-- Edit Button -->
                                                <a href="<?php echo e(route('admin.edit_store_owner', ['id' => $store_owner->id])); ?>"
                                                    class="btn btn-primary btn-lg">
                                                ...
                                                <!-- Delete Button -->
                                                <form
                                                    action="<?php echo e(route('admin.delete_store_owner', ['id' => $store_owner->id])); ?>"
...
<?php echo $__env->make('layouts.admin_master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Handyman-website\resources\views/admin/storeowner/view_store_owner.blade.php ENDPATH**/ ?>