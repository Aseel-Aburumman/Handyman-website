        ...
        <div class="row">
                        ...
                        <div class="col-md-8">
                            <div class="card chat-card shadow-sm">
                                ...
                                <div class="card-footer chat-footer">
                                    <form action="<?php echo e(route('chat.sendadmin')); ?>" method="POST">
                                        <?php echo csrf_field(); ?>
                                ...
                                <div class="card-body chat-history-body">
                                    <?php if($chatPartners->isNotEmpty()): ?>
                                        <?php $__currentLoopData = $chatPartners; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $partner): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <a href="<?php echo e(route('chatadmin', ['receiverId' => $partner->id, 'ticketId' => $ticket->id])); ?>"
            ...
            <script>
                $('form').on('submit', function(e) {
                    ...
                    $.ajax({
                        url: '<?php echo e(route('chat.sendadmin')); ?>',
                        method: 'POST',
                        data: {
            ...
            <script>
                ...
                function fetchMessages() {
                    $.ajax({
                        url: '<?php echo e(route('chat.fetchadmin', ['receiverId' => $receiverId])); ?>',
                        method: 'GET',
