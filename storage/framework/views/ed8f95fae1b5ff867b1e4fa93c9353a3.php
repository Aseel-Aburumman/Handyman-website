...
<aside id="sidebar" class="sidebar">
    ...
    <li class="nav-item">
        <a class="nav-link collapsed" href="<?php echo e(route('admin.agreements.index')); ?>">
            <i class="bi bi-person"></i>
            <span>Agreements Center</span>
        </a>
    </li><!-- End Profile Page Nav -->

    <li class="nav-item">
        <a class="nav-link collapsed" href="<?php echo e(route('admin.applications.index')); ?>">
            <i class="bi bi-person"></i>
