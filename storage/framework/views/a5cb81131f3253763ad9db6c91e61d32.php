                    ...
                    <div class="hero-inner">
                        <div class="container">
                            <div class="hero-style1">
                                ...
                                <h1 class="hero-title">
                                    <span class="title1" data-ani="slideinup" data-ani-delay="0.2s"><?php echo e(__('messages.bannerTitleA1')); ?></span>
                                    <span class="title2" data-ani="slideinup" data-ani-delay="0.4s"><?php echo e(__('messages.bannerTitleA2')); ?></span>
                                    <span class="title3" data-ani="slideinup" data-ani-delay="0.6s"><?php echo e(__('messages.bannerTitleA3')); ?>

                                    
                                    </span>
                                </h1>
                                <p class="hero-text" data-ani="slideinup" data-ani-delay="0.8s"><?php echo e(__('messages.bannerSubTitleA1')); ?></p>
                                <a href="<?php echo e(route('service')); ?>" class="th-btn style3" data-ani="slideinup" data-ani-delay="1s"><?php echo e(__('messages.bannerBtn')); ?><i class="fas fa-arrow-right ms-2"></i></a>
                            </div>
                        </div>
                    ...
                    <div class="hero-inner">
                        <div class="container">
                            <div class="hero-style1">
                                ...
                                <h1 class="hero-title">
                                    <span class="title1" data-ani="slideinup" data-ani-delay="0.2s"><?php echo e(__('messages.bannerTitleB1')); ?></span>
                                    <span class="title2" data-ani="slideinup" data-ani-delay="0.4s"><?php echo e(__('messages.bannerTitleB2')); ?></span>
                                    <span class="title3" data-ani="slideinup" data-ani-delay="0.6s"><?php echo e(__('messages.bannerTitleB3')); ?>

                                    
                                    </span>
                                </h1>
                                <p class="hero-text" data-ani="slideinup" data-ani-delay="0.8s"><?php echo e(__('messages.bannerSubTitleB1')); ?></p>
                                <a href="service.html" class="th-btn style3" data-ani="slideinup" data-ani-delay="1s"><?php echo e(__('messages.bannerBtn')); ?><i class="fas fa-arrow-right ms-2"></i></a>
                            </div>
                        </div>
                        <div class="hero-img" data-ani="slideinright" data-ani-delay="0.2s">
                            <div class="shape1">
                    ...
                    <div class="hero-inner">
                        <div class="container">
                            <div class="hero-style1">
                                ...
                                <h1 class="hero-title">
                                    <span class="title1" data-ani="slideinup" data-ani-delay="0.2s"><?php echo e(__('messages.bannerTitleC1')); ?></span>
                                    <span class="title2" data-ani="slideinup" data-ani-delay="0.4s"><?php echo e(__('messages.bannerTitleC2')); ?></span>
                                    <span class="title3" data-ani="slideinup" data-ani-delay="0.6s"><?php echo e(__('messages.bannerTitleC3')); ?>

                                     
                                     </span>
                                </h1>
                                <p class="hero-text" data-ani="slideinup" data-ani-delay="0.8s"><?php echo e(__('messages.bannerSubTitleC1')); ?></p>
                                <a href="service.html" class="th-btn style3" data-ani="slideinup" data-ani-delay="1s"><?php echo e(__('messages.bannerBtn')); ?><i class="fas fa-arrow-right ms-2"></i></a>
                            </div>
                        </div>
                        <div class="hero-img" data-ani="slideinright" data-ani-delay="0.2s">
            ...
            <div class="row justify-content-center">
                <div class="col-xl-8 col-md-10">
                    <div class="title-area text-center">
                        <span class="sub-title"><img src="assets/img/theme-img/title_icon.svg" alt="Icon"><?php echo e(__('messages.serviceSmallTitle')); ?></span>
...
<div class="filter-menu style2 mt-0 indicator-active filter-menu-active">
    <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <button data-filter=".cat<?php echo e($index); ?>" class="tab-btn" type="button"><?php echo e($category->name); ?></button>
...
<?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    <div class="swiper th-slider has-shadow category-services cat<?php echo e($index); ?>" style="display:none" data-slider-options='{"loop":false,"slidesPerGroup":"2","breakpoints":{"0":{"slidesPerView":1},"576":{"slidesPerView":"1"},"768":{"slidesPerView":"2"},"992":{"slidesPerView":"2"},"1200":{"slidesPerView":"3"},"1300":{"slidesPerView":"4"}}}'>
        <div class="swiper-wrapper">
                    ...
                    <div class="service-card">
                        ...
                        <div class="box-icon">
                            ...
                            ?>
                                ...
                                <img src="<?php echo e(asset('assets/img/icon/' .$serviceImages[$service->name])); ?>" alt="Icon">
