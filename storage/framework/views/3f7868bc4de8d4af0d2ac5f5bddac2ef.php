                    ...
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><?php echo e($store->storeOwner->user->name); ?></td> <!-- Access the owner's user name -->
                                <td><?php echo e($store->products_count); ?></td>
                                <td><?php echo e($store->status->name); ?></td>
                                <td>
                                    <a href="<?php echo e(route('store_control_center.view_store', ['id' => $store->id])); ?>" class="btn btn-info btn-sm">View</a>
                                    <a href="<?php echo e(route('store_control_center.edit_store', $store->id)); ?>" class="btn btn-warning btn-sm">Edit</a>
                                    <a href="<?php echo e(route('store_control_center.delete_store', $store->id)); ?>" class="btn btn-danger btn-sm">Delete</a>
                                </td>
                            </tr>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </tbody>
