                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                <select name="handyman" class="form-select">
                                    ...
                                    <option value="<?php echo e($handyman->id); ?>"><?php echo e($handyman->user->name); ?></option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
                            </div>
                            <div class="col-md-3">
                    ...
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><?php echo e($gig->handyman->user->name); ?></td>
                                ...
                                <td>
                                    ...
                                    <a href="<?php echo e(route('admin.delete_gig', $gig->id)); ?>" class="btn btn-danger btn-sm">Delete</a>
                                </td>
                            </tr>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </tbody>
...
<?php echo $__env->make('layouts.admin_master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Handyman-website\resources\views/admin/all_gigs.blade.php ENDPATH**/ ?>