                                ...
                                <div class="tab-pane fade show active profile-overview" id="profile-overview">
                                    ...
                                    <div class="row mt-4">
                                        <div class="col-lg-12 text-center">
                                            ...
                                            <!-- Edit Button -->
                                            <a href="<?php echo e(route('admin.edit_customer', ['id' => $customer->id])); ?>" class="btn btn-primary btn-lg">
                                                <i class="fa-solid fa-pencil"></i> Edit
                                            </a>

                                            <!-- Delete Button -->
                                            <form action="<?php echo e(route('admin.delete_customer', ['id' => $customer->id])); ?>" method="POST" style="display:inline;" onsubmit="return confirm('Are you sure you want to delete this handyman?');">
                                                <?php echo csrf_field(); ?>
