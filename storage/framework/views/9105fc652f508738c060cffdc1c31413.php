                    ...
                    <div class="card-body profile-card pt-4">
                        ...
                        <div class="row w-100">
                            ...
                            <div class="col-lg-4 d-flex justify-content-center align-items-center">
                                <img src="<?php echo e($customer->image ? url('/user_images/' . $customer->image) : url('assets/img/profile-img.jpg')); ?>"
                                    ...
                                    <div class="tab-pane fade show active profile-overview" id="profile-overview">
                                        ...
                                        <div class="row mt-4">
                                            <div class="col-lg-12 text-center">
                                                ...
                                                <a href="<?php echo e(route('chatadmin2', ['receiverId' => $customer->id])); ?>"
                                                    class="btn btn-primary btn-lg">
                                                    <i class="bi bi-chat-dots"></i> Go to Chat Center
                                                </a>

                                                <!-- Edit Button -->
                                                <a href="<?php echo e(route('admin.edit_customer', ['id' => $customer->id])); ?>"
                                                    class="btn btn-primary btn-lg">
                                                ...
                                                <!-- Delete Button -->
                                                <form
                                                    action="<?php echo e(route('admin.delete_customer', ['id' => $customer->id])); ?>"
...
<?php echo $__env->make('layouts.admin_master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Handyman-website\resources\views/admin/customers/view_customer.blade.php ENDPATH**/ ?>