<?php $__env->startSection('content'); ?>
        ...
        <div class="container">
            <div class="breadcumb-content">
                <?php if(app()->getLocale() == 'en'): ?>
                    <h1 class="breadcumb-title"><?php echo e($store->name); ?> &nbsp
                        <?php echo e(__('messages.Profilep')); ?> </h1>
                <?php else: ?>
                    <h1 class="breadcumb-title"> <?php echo e(__('messages.store')); ?> &nbsp
                        <?php echo e($store->name); ?></h1>
                <?php endif; ?>
    ...
    <div class="space overflow-hidden " data-bg-src="<?php echo e(asset('assets/img/bg/about_bg_4.png')); ?>">
        <div class="container">
                ...
                <div class="col-xl-6 text-center text-xl-start">
                    <div class="pe-xxl-5">
                        ...
                        <div class="aboutUsContainer checklist list-one-column fw-regular">
                            <ul>
                                <li><?php echo e(__('messages.TotalReviews')); ?>&nbsp

                                    <?php echo e($reviewCount); ?></li>


                                <li><?php echo e(__('messages.TotalSales')); ?>&nbsp
                            ...
                            <div class="col-xl-3 col-lg-4 col-sm-6">
                                <div class="th-product product-grid">
                                    ...
                                    <div class="product-content">
                                        ...
                                        <?php else: ?>
                                            <span class="price"> <?php echo e(__('messages.JD')); ?>&nbsp<?php echo e($product->price); ?>
