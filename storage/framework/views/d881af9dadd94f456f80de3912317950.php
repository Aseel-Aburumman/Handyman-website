        ...
        <div class="row">
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <form class="row g-3" method="POST" action="<?php echo e(route('admin.update_store_owner', $store_owner->id)); ?>"
                        ...
                        <div class="col-md-12">
                            ...
                            <input type="text" name="name" class="form-control" id="inputName"
                                value="<?php echo e(old('name', $store_owner->name)); ?>">
                        </div>
                        <div class="col-md-6">
                            <label for="inputEmail" class="form-label">Email</label>
                            <input type="email" name="email" class="form-control" id="inputEmail"
                                value="<?php echo e(old('email', $store_owner->email)); ?>">
                        </div>
                        <div class="col-md-6">
                        ...
                        <div class="col-md-12">
                            ...
                            <?php if($store_owner->image): ?>
                                <img src="<?php echo e(url('/user_images/' . $store_owner->image)); ?>" alt="Profile Image"
                        ...
                        <div class="col-12">
                            ...
                            <input type="text" name="location" class="form-control" id="inputAddress"
                                value="<?php echo e(old('location', $deliveryInfo->location ?? '')); ?>" placeholder="1234 Main St">
                        </div>
                        <div class="col-12">
                            ...
                            <input type="text" name="building_no" class="form-control" id="inputBuilding"
                                value="<?php echo e(old('building_no', $deliveryInfo->building_no ?? '')); ?>"
                                placeholder="Apartment, studio, or floor">
                        </div>
                        <div class="col-md-6">
                            <label for="inputCity" class="form-label">City</label>
                            <input type="text" name="city" class="form-control" id="inputCity"
                                value="<?php echo e(old('city', $deliveryInfo->city ?? '')); ?>">
                        </div>
                        <div class="col-md-6">
                            <label for="inputPhone" class="form-label">Phone</label>
                            <input type="text" name="phone" class="form-control" id="inputPhone"
                                value="<?php echo e(old('phone', $deliveryInfo->phone ?? '')); ?>">
                        </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" name="store_name" class="form-control" id="store_name"
                                value="<?php echo e(old('store_name', $storeOwnerDetails->store_name ?? '')); ?>">
                        </div>
                        <div class="col-md-6">
                            <label for="contact_number" class="form-label">Contact Number</label>
                            <input type="text" name="contact_number" class="form-control" id="contact_number"
                                value="<?php echo e(old('contact_number', $storeOwnerDetails->contact_number ?? '')); ?>">
                        </div>
                        <div class="col-md-6">
                            <label for="address" class="form-label">Store Address</label>
                            <input type="text" name="address" class="form-control" id="address"
                                value="<?php echo e(old('address', $storeOwnerDetails->address ?? '')); ?>">
                        </div>
                        <div class="col-md-6">
                            ...
                            <input type="text" name="certificate_id" class="form-control" id="certificate_id"
                                value="<?php echo e(old('certificate_id', $storeOwnerDetails->certificate_id ?? '')); ?>">
                        </div>
                        <div class="col-md-6">
